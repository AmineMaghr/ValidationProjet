...
old_text = r'slotSelectionScreen\.Visible = false.+?vmMaster\.Visible = true.*?if resetGameUI then resetGameUI\(\) end.*?end\).*?else'

new_text = '''slotSelectionScreen.Visible = false

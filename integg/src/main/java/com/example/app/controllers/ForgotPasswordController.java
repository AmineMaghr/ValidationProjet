    ...
    private void showMessage(String message, String type) {
        Platform.runLater(() -> {
            ...
            if (type.equals("error")) {
                messageLabel.setStyle("-fx-text-fill: #EF5350; -fx-background-color: rgba(239,83,80,0.1); -fx-padding: 12; -fx-background-radius: 8;");
            } else {
                messageLabel.setStyle("-fx-text-fill: #18E3A4; -fx-background-color: rgba(24,227,164,0.1); -fx-padding: 12; -fx-background-radius: 8;");
            }
            new java.util.Timer().schedule(new java.util.TimerTask() {

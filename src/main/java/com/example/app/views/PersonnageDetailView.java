...
public class PersonnageDetailView extends VBox {
    ...
    private void setupHeader() {
        ...
        boolean canEdit = com.example.app.utils.UserSession.isAdmin() ||
            (com.example.app.utils.UserSession.isLoggedIn() &&
             personnage.getCreatorId() == com.example.app.utils.UserSession.getCurrentUserId());
        ...
        HBox actionsBox = new HBox(15, classBadge, btnEdit, btnDelete, btnExport);
    ...
    private void setupDashboard() {
        ...
        boolean canEditStats = com.example.app.utils.UserSession.isAdmin() ||
            (com.example.app.utils.UserSession.isLoggedIn() &&
             personnage.getCreatorId() == com.example.app.utils.UserSession.getCurrentUserId());
        ...
        rollBtn.setVisible(canEditStats);
        rollBtn.setManaged(canEditStats);
